...
func (h *HTTPHandler) Routes() http.Handler {
	...
	r.Post("/api/git/remote/fetch", h.protectedEndpoint(h.handleGitFetch))
	r.Post("/api/git/remote/pull", h.protectedEndpoint(h.handleGitRemotePull))
	r.Post("/api/git/remote/push", h.protectedEndpoint(h.handleGitRemotePush))
	r.Post("/api/git/remote/push/upstream", h.protectedEndpoint(h.handleGitPushUpstream))
	r.Post("/api/git/remote/commit-and-push", h.protectedEndpoint(h.handleGitCommitAndPush))
	...
	r.Post("/api/agents/restart-all", h.protectedEndpoint(h.handleAgentRestartAll))
...
func (h *HTTPHandler) handleGitRemotePull(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandler) handleGitRemotePush(w http.ResponseWriter, r *http.Request) {
	rootID, ok := decodeGitRootRequest(w, r)
	if !ok {
		return
	}
