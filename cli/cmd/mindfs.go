...
func printUninstallCommand() {
	if runtime.GOOS == "windows" {
		...
		fmt.Fprintln(os.Stdout, "Download scripts/install.ps1 from https://github.com/shuguangnet/mindfs, then run it with -Uninstall.")
		fmt.Fprintln(os.Stdout, "")
		fmt.Fprintln(os.Stdout, "Purge MindFS, including user config and logs:")
		fmt.Fprintln(os.Stdout, "Download scripts/install.ps1 from https://github.com/shuguangnet/mindfs, then run it with -Uninstall -Purge.")
		return
	}
	fmt.Fprintln(os.Stdout, "Run one of the following commands manually:")
	fmt.Fprintln(os.Stdout, "")
	...
	fmt.Fprintln(os.Stdout, `curl -fsSL https://raw.githubusercontent.com/shuguangnet/mindfs/main/scripts/install.sh -o "$installer"`)
