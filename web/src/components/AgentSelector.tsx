...
export function AgentSelector({
  ...
  const submenuEfforts = useMemo(() => {
    const modelEfforts = submenuSelectedModel?.efforts ?? [];
  ...
  const fallbackEffort =
    submenuSelectedModel?.default_effort ||
    submenuAgentStatus?.default_effort ||
    "";
  const displayedEffort =
    (submenuAgentStatus?.name === agent ? effort : "") ||
    fallbackEffort ||
    "Auto";
